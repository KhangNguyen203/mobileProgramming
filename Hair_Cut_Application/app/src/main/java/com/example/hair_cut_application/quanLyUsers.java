...
public class quanLyUsers extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        String chuoi = String.valueOf(myList.get(position));
                        String sdt = laySoDienThoai(chuoi);

                        UserDTO u = usersDAO.layDuLieu(sdt);
                        eTxtHoTen.setText(u.getUsername());
                        eTxtSDT.setText(u.getPhoneNumber());
                        eTxtMatKhau.setText(u.getPassword());
                    }
                });
            }
        });
    ...
    public static String laySoDienThoai(String chuoi) {
        String[] ketQua = chuoi.split(" - ");
