    ...
    private void xuLySKClick() {
            ...
            public void onClick(View v) {
                ...
                lvShop.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ShopDTO s = shopDAO.getAllByID(String.valueOf(position+1));

                        eTxtIdShop.setText(String.valueOf(position+1));
                        eTxtTenShop.setText(s.getName());
                        eTxtDCShop.setText(s.getDiaChi());
                        eTxtHotlineShop.setText(s.getHotline());
                    }
                });
            }
        });
        ...
        btnXuatDLStylist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lvStylist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        StylistDTO st = stylistDAO.getAllByID(String.valueOf(position+1));

                        eTxtTenStylist.setText(st.getTen());
                        eTxtIdStylist.setText(st.getId());
                        eTxtSDTStylist.setText(st.getSdt());
                        eTxtGioiTinhStylist.setText(st.getGioiTinh());
                        eTxtEmailStylist.setText(st.getEmail());
                        eTxtMotaStylist.setText(st.getMoTa());
                    }
                });
            }
        });
