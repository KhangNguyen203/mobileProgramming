...
public class QLDHAdapter extends BaseAdapter {
    ...
    StylistDAO stylistDAO = adminQuanLyDH.stDAO;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String stylistName = getNameStylistByID(datLichDTO.getTho());

        holder.txtQLDHNumberPhone.setText(datLichDTO.getSdt());
        holder.txtQLDHStylist.setText(stylistName);
    ...
    public String getNameStylistByID(String id){
        StylistDTO st = stylistDAO.getAllByID(id);
