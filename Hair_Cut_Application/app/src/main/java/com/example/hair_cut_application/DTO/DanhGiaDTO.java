...
public class DanhGiaDTO {
    ...
    public DanhGiaDTO(int lichSuID, float shopRating, String shopReview, float stylistRating, String stylistReview, String tgDG) {
    ...
    public DanhGiaDTO(LichSuDTO lichSuDTO, float shopRating, String shopReview,float stylistRating, String stylistReview, String tgDG){
